...
extension Array<MovieCastMember> {
    static var mock: [MovieCastMember] {
        [
            ...
            MovieCastMember(id: 3107735, name: "Lillia Langley", character: "Drive in Movie Theatre"),
            ...
            MovieCastMember(id: 3144894, name: "Ross Donnelly", character: "Washington Pedestri"),
